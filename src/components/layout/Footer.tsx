...
import { branches, callUrl, restaurant, whatsappUrl } from '@/config/restaurant';
...
export function Footer() {
  return <footer className="site-footer">
    <div className="footer-main">
      ...
      <div className="footer-column footer-contact"><h2>Support</h2><a href={callUrl}><Phone size={16} /> {restaurant.phone}</a><a href={whatsappUrl()} target="_blank" rel="noreferrer"><MessageCircle size={16} /> WhatsApp <ArrowUpRight size={14} /></a><Link href="/contact">Contact</Link></div>
    </div>
